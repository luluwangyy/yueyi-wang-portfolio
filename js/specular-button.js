// Vanilla-JS port of the SpecularButton React component. The WebGL shine
// effect is plain `ogl` code — only the React wrapper (useEffect/useRef/
// props) has been stripped and replaced with a plain init function.
//
// Usage:
//   import { createSpecularButton } from "./specular-button.js";
//   createSpecularButton(buttonEl, { lineColor: "#fff", ... });
...
export function createSpecularButton(btn, opts = {}) {
  const props = {
    radius: 18,
    lineColor: "#ffffff",
    baseColor: "#525252",
